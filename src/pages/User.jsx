  ...
  return (
    <>
      ...
      <div className="w-full mx-auto lg:w-10/12">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 lg:gris-cols-3 md:grid-cols-3 mb-8 md:gap-8">
          ...
          <div className="col-span-2">
            <div className="mb-6">
              <h1 className="text-3cl card-title">
                {name}
                <div className="ml-2 mr-1 badge badge-success">{type}</div>
                {/* //if user.login is hireable is true the display hireable value */}
                {hireable && (
            ...
            <div className="w-full rounded-lg shadow-md bg-base-100 stats">
              {/* //if location is true display location values */}
              {location && (
                <div className="stat">
